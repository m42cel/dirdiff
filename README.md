...
| `--version` | Print version, commit, and platform, then exit. Released binaries report their tag (`dirdiff v1.0.0 (b1946ac92492, go1.27.1, darwin/arm64)`); builds made from a source checkout report `dev` plus the commit they came from. |
